...
<!--===============================================================================================-->	
	<link rel="icon" type="frontend/image/png" href="frontend/login/images/icons/favicon.ico"/>
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('frontend/login/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="{{url('/creer_utilisateur')}}" method="post">
					{{ csrf_field() }}
					<a href="{{URL::to('/')}}">
						<span class="login100-form-logo">
							<i class="zmdi zmdi-landscape"></i>
							<span class="iconify" data-icon="zmdi:landscape"></span>
						</span>
					</a>
					...
					<div class="wrap-input100 validate-input">
						<div class="row">
							<div class="col">
							  <input type="text" class="input100" placeholder="Nom" name="nom">
							</div>
							<div class="col">
							  <input type="text" class="input100" placeholder="Prenom" name="prenom">
							</div>
						  </div>
					</div>
                    <div class="wrap-input100 validate-input" data-validate = "Enter username">
						<select class="input100" type="text" name="role_id">
                            <option value="">--SVP choisir un role--</option>
                            @foreach ($roles as $role)
								@if ($role->role != "ADMIN")
									<option value="{{$role->id}}" style="color:black;">{{$role->role}}</option>
								@endif
                            @endforeach
                        </select>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validat="Enter password">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="{{URL::to('/authentification')}}">
